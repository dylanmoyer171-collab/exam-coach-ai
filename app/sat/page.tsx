...
import { SAT_CONFIG } from "@/lib/exam-data";
import { generateStudyPlan, type StudyPlan } from "@/lib/study-plan-generator";
import { predictSATScore, type ScorePrediction } from "@/lib/score-predictor";
...
export default function SATPage() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!currentScore || currentScore < 400 || currentScore > 1600) {
      newErrors.push("Current score must be between 400–1600");
    }
    if (!targetScore || targetScore < 400 || targetScore > 1600) {
      newErrors.push("Target score must be between 400–1600");
    }
  ...
  return (
    <div className="min-h-screen bg-slate-950 px-4 py-8 sm:px-8">
      <div className="mx-auto max-w-6xl">
        {/* Header */}
        <div className="mb-8">
          <Badge variant="secondary" className="mb-4">SAT</Badge>
          <h1 className="text-4xl font-bold text-white mb-2">SAT Study Plan Generator</h1>
          <p className="text-slate-400">
            Evidence-Based Reading &amp; Writing (200–800) + Math (200–800) = Total (400–1600)
          </p>
        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="mt-1"
                    />
                    <p className="text-xs text-slate-400 mt-1">400–1600</p>
                  </div>
